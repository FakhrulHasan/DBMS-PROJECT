...
//   }
  ...
  if (isset($_POST["submitButton"])) {
    ...
    $s = "SELECT parent_id FROM parents WHERE parent_id = '$parent_id'";
    ...
    if($num == 0){
        ...
        // $query = "INSERT INTO parent (first_name, last_name, gender, occupation, parent_id, blood_group, religion, email, address, phone)
        // VALUES
        //     ('$firstname','$lastname','$gender','$Occupation','$parent_id','$bloodgroup',' $religion','$email','$address','$phone')";


$query2 = "INSERT INTO `parents`(`first_name`, `last_name`, `gender`, `Occupation`, `parent_id`, `blood_group`, `religion`, `email`, `address`, `phone`) 
VALUES ('$firstname', '$lastname','$gender','$Occupation','$parent_id','$bloodgroup','$religion','$email','$address','$phone')";


                if(mysqli_query($conn, $query2)){
                    echo "<script>
                    alert('This parent has been added');
                    </script>";
                } else{
        ...
        echo "<script>
        alert('This parent already exists in database');
        </script>";
    }
